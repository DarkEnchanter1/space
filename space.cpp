...
int physicsLoop() {
	...
	double factor = res.tv_nsec/1000000000.0; //The amount of actual detail in the nanosecond counter... might not actually be accurate?
	                                          //TODO: Check if this is actually sensical
